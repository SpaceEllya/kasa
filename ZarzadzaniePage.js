              ...
              <View style={styles.additionalInfoBoxSecond}>
                <View style={styles.itionalInfoBoxSecondInfo}>
                  ...
                  <View style={styles.itionalInfoBoxSecondInfoText}>
                    ...
                    <Text style={styles.infoBoxSecondInfoTextSecond}>Status: {order.order}</Text>
                  </View>
                </View>
                <View style={styles.additionalInfoBoxSecondRowTwo}>
                  <View>
                    <Text style={styles.infoBoxSecondInfoTextRowTwo}>Hired time</Text>
                    <Text style={styles.infoBoxSecondInfoTextSecondRowTwo}>{order.table}</Text>
                  </View>
                  <View>
                    <Text style={styles.infoBoxSecondInfoTextRowTwo}>Phone</Text>
                    <Text style={styles.infoBoxSecondInfoTextSecondRowTwo}>{order.time}</Text>
                  </View>
                </View>
                <View style={styles.additionalInfoBoxSecondRowTwo}>
                  <View>
                    <Text style={styles.infoBoxSecondInfoTextRowTwo}>Last login</Text>
                    <Text style={styles.infoBoxSecondInfoTextSecondRowTwo}>{order.amount}</Text>
                  </View>
                  <View>
                    <Text style={styles.infoBoxSecondInfoTextRowTwo}>email</Text>
                    <Text style={styles.infoBoxSecondInfoTextSecondRowTwo}>{order.email}</Text>
                  </View>
                </View>
              </View>
...
<TextInput
  style={styles.modifyModalInput}
  placeholder="email"
  value={mealDetails.email}
  onChangeText={(text) => setMealDetails({ ...mealDetails, email: text })}
/>
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalText}>Dodaj pracownika</Text>
