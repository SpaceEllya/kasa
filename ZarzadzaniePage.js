    ...
    <View style={styles.container}>
            ...
            <View style={styles.additionalInfoBox}>
              <View style={styles.additionalInfoBoxSecond}>
                <View style={styles.itionalInfoBoxSecondInfo}>
                  ...
                  <View style={styles.itionalInfoBoxSecondInfoText}>
                    <Text style={styles.infoBoxSecondInfoText}>Jan Kowalski</Text>
                ...
                <View style={styles.additionalInfoBoxSecondRowTwo}>
                  <View>
                    <Text style={styles.infoBoxSecondInfoTextRowTwo}>Następna zmiana</Text>
                    <Text style={styles.infoBoxSecondInfoTextSecondRowTwo}>6:00 14.06.2023</Text>
                  </View>
                  <View>
                    <Text style={styles.infoBoxSecondInfoTextRowTwo}>Data Urodzenia</Text>
                    <Text style={styles.infoBoxSecondInfoTextSecondRowTwo}>XX.XX.XXXX</Text>
                  </View>
                </View>
                <View style={styles.additionalInfoBoxSecondRowTwo}>
                  <View>
                    <Text style={styles.infoBoxSecondInfoTextRowTwo}>Pensja</Text>
                    <Text style={styles.infoBoxSecondInfoTextSecondRowTwo}>2500zł</Text>
                  </View>
                  <View>
                    <Text style={styles.infoBoxSecondInfoTextRowTwo}>Etat</Text>
                    <Text style={styles.infoBoxSecondInfoTextSecondRowTwo}>Pół</Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.additionalInfoBoxEdit}>
                ...
                <TouchableOpacity onPress={() => handleModifyPress()}>
                  <Text style={styles.additionalInfoBoxEditSecond}>Szczegóły pracownika</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
      ...
      <Modal animationType="slide" transparent={true} visible={isModalVisible} onRequestClose={() => setModalVisible(false)}>
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalText}>Dodaj Nowego Pracownika</Text>

            <TextInput
              style={styles.modalInput}
              placeholder="Następna zmiana"
            ...
            <TouchableOpacity onPress={handleAddOrder}>
              <Text style={styles.modalAddOrderButton}>Dodaj pracownika</Text>
            </TouchableOpacity>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity onPress={handleAddOrderPress} style={styles.changeUserButtonTwo}>
          <Text style={styles.changeUserButtonTextTwo}>Dodaj pracownika</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
